...
const PlayPauseButton = ({ message, ttsEnabled, isPlaying, setIsPlaying }) => {
    ...
    function createSound(buffer, context) {
        ...
        const play = function() {
            ...
            sourceNode.onended = () => { setIsPlaying(false); playing = false; };
    ...
    return <IconButton onClick={handleClick}>{isPlaying ? <PauseIcon iconstyle={iconStyle} /> : <PlayIcon iconstyle={iconStyle} />}</IconButton>
};
